...
# Creates sample parks, subareas, and activity records
...
TABLE_NAME="${TABLE_NAME:-ParksAr-lza-dev}"
...
put_item() {
  ...
  aws dynamodb put-item \
    ...
    --region ca-central-1 >/dev/null 2>&1 && echo "✓ Added: $pk / $sk" || echo "✗ Failed: $pk / $sk"
}
